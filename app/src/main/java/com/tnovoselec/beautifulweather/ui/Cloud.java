...
public class Cloud {
  ...
  private static final double R1_DEFAULT = 0.2875;
  private static final double R2_DEFAULT = 0.2041667;
  private static final double OFFSET_DEFAULT = 0.00023125;
  ...
  public Path getCloud(float centerX, float centerY, int dimension, double count) {
    ...
    int r1 = (int) (R1_DEFAULT * dimension);
    int r2 = (int) (R2_DEFAULT * dimension);
    double offset = OFFSET_DEFAULT * dimension;
